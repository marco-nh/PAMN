...
import com.example.flightplannifier.NavigationDestination
import com.example.flightplannifier.R
            ...
            FlightResults(
                ...
                onFavoriteClick = { s1: String, s2: String ->
                    ...
                    if(viewModel.flightAdded){
                        Toast.makeText(context,"Añadido favorito", Toast.LENGTH_SHORT).show()
                    }else{
                        Toast.makeText(context,"Eliminado favorito", Toast.LENGTH_SHORT).show()
                    }
                }
            )
    }
